...
public class OrgUser implements User, Serializable
{
    ...
    private transient KeyStore keyValStore;
    private String keyValStoreName;

    OrgUser(String name, String org, KeyStore fs) {
        this.name = name;
    ...
    OrgUser restoreState() {
        ...
        if (null != memberStr) {
            ...
            try {
                ...
                OrgUser state = (OrgUser) ois.readObject();
                if (state != null) {
